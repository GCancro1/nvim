...
require("lazy").setup({
	...
	{ -- Highlight, edit, and navigate code
		...
		build = ":TSUpdate",
		-- build = false,
		-- main = "nvim-reesitter.configs", -- Sets main module to use for opts
		...
		config = function()
			require("nvim-surround").setup({
				...
				keymaps = {
					...
					insert_line = "<C-g>S", -- Add surround on a whole line in insert
					normal = "ys", -- Add surround in normal mode (default)
					normal_cur = "yss", -- Add surround for whole line
					normal_line = "yS",
					normal_cur_line = "ySS",
